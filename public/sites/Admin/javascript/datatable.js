...
// Automatically refresh alternating row background colours on change
            ...
            if ( batchPages > 1 ) {
              ...
              var select = '<select name="page" onchange="Kuu_DataTable.load(this.form.page.options[this.form.page.selectedIndex].value);">';
            ...
            if ( batchCurrentPage > 1 ) {
              batchPageLinks = '<a id="batchPrevLink" href="#" onclick="Kuu_DataTable.load(' + (batchCurrentPage - 1) + '); return false;">' + batchIconNavigationBack + '</a>';
            } else {
            ...
            if ( batchCurrentPage < batchPages ) {
              batchPageLinks += '<a id="batchNextLink" href="#" onclick="Kuu_DataTable.load(' + (batchCurrentPage + 1) + '); return false;">' + batchIconNavigationForward + '</a>';
            } else {
