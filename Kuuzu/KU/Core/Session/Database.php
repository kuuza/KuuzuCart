...
namespace Kuuzu\KU\Core\Session;
...
class Database extends \Kuuzu\KU\Core\SessionAbstract implements \SessionHandlerInterface
{
 ...
 */
    ...
    {
        return KUUZU::callDB('Session\Database\Check', [
            'id' => $session_id
        ], 'Core');
    }
 ...
 */
    ...
    {
        $result = KUUZU::callDB('Session\Database\Get', [
            'id' => $session_id
        ], 'Core');
 ...
 */
    ...
    {
        return KUUZU::callDB('Session\Database\Save', [
            'id' => $session_id,
            'expiry' => time(),
            'value' => $session_data
        ], 'Core');
 ...
 */
    ...
    {
        return KUUZU::callDB('Session\Database\Delete', [
            'id' => $session_id
        ], 'Core');
    }
 ...
 */
    ...
    {
        return KUUZU::callDB('Session\Database\DeleteExpired', [
            'expiry' => $maxlifetime
        ], 'Core');
    }
}
