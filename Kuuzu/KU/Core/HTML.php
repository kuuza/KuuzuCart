 ...
 */
    ...
    public static function icon($image, $title = null, $group = null, $parameters = null) {
      if ( is_null($title) ) {
        $title = KUUZU::getDef('icon_' . substr($image, 0, strpos($image, '.')));
      }
      ...
      return static::image(KUUZU::getPublicSiteLink('templates/' . Registry::get('Template')->getCode() . '/images/icons/' . (!empty($group) ? $group . '/' : null) . $image), $title, null, null, $parameters);
    }
 ...
 */
    ...
    public static function iconRaw($image, $group = null) {
      ...
      return KUUZU::getPublicSiteLink('templates/' . Registry::get('Template')->getCode() . '/images/icons/' . (!empty($group) ? $group . '/' : null) . $image);
    }
 ...
 */
    ...
    public static function hiddenSessionIDField() {
      ...
      if ( $KUUZU_Session->hasStarted() && (strlen(SID) > 0) ) {
        return static::hiddenField($KUUZU_Session->getName(), $KUUZU_Session->getID());
      }
    }
