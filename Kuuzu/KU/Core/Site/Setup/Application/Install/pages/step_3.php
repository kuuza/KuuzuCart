...
<div class="mainBlock">
  <div class="stepsBox">
    <ol>
      ...
      <li style="font-weight: bold;"><?php echo KUUZU::getDef('box_steps_step_3'); ?></li>
    </ol>
  </div>
...
<div class="contentBlock">
  <div class="infoPane">
    <h3><?php echo KUUZU::getDef('box_info_step_3_title'); ?></h3>

    <div class="infoPaneContents">
      <p><?php echo KUUZU::getDef('box_info_step_3_text'); ?></p>
    </div>
  </div>

  <div class="contentPane">
    <h2><?php echo KUUZU::getDef('page_heading_finished'); ?></h2>
...
<?php
  ...
  $dir_fs_document_root = KUUZU_PUBLIC_BASE_DIRECTORY;

  $DL_Cache = new DirectoryListing(KUUZU::BASE_DIRECTORY . 'Work/Cache');
...
EOT;
  ...
  if ( is_writable(KUUZU::BASE_DIRECTORY . 'Config/settings.ini') ) {
    file_put_contents(KUUZU::BASE_DIRECTORY . 'Config/settings.ini', $file_contents);
?>

    <p><?php echo KUUZU::getDef('text_successful_installation'); ?></p>

<?php
  } else {
?>

    <form name="install" action="<?php echo KUUZU::getLink(null, null, 'step=3'); ?>" method="post">

    <div class="noticeBox">
      <p><?php echo sprintf(KUUZU::getDef('error_configuration_file_not_writeable'), KUUZU::BASE_DIRECTORY . 'Config/settings.ini'); ?></p>

      <p align="right"><?php echo HTML::button(array('icon' => 'refresh', 'title' => KUUZU::getDef('button_retry'))); ?></p>
...
?>
    ...
    <p><?php echo KUUZU::getDef('text_go_to_shop_after_cfg_file_is_saved'); ?></p>
...
?>
    ...
    <p align="center"><?php echo HTML::button(array('href' => $http_server . $http_dir_ws . 'index.php?Shop', 'icon' => 'cart', 'title' => KUUZU::getDef('button_shop'))) . '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' . HTML::button(array('href' => $http_server . $http_dir_ws . 'index.php?Admin', 'icon' => 'gear', 'title' => KUUZU::getDef('button_admin'))); ?></p>
  </div>
</div>
