...
text_installation = This web-based installation procedure will setup and configure Kuuzu Cart to correctly run on this server.<br /><br />Please following the on-screen instructions that will take you through the web server, database server, and online store configuration options.
...
box_info_step_3_text = Congratulations on installing and configuring your new Kuuzu Cart store!<br /><br />We wish you all the best with the business of your online store and look forward to seeing you in our community!<br /><br />- The Kuuzu Team
