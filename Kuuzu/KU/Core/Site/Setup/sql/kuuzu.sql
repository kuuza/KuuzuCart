...
DROP TABLE IF EXISTS kuu_action_recorder;
CREATE TABLE kuu_action_recorder (
...
DROP TABLE IF EXISTS kuu_address_book;
...
DROP TABLE IF EXISTS kuu_administrator_shortcuts;
...
DROP TABLE IF EXISTS kuu_administrators;
...
DROP TABLE IF EXISTS kuu_administrators_access;
...
DROP TABLE IF EXISTS kuu_audit_log;
...
DROP TABLE IF EXISTS kuu_audit_log_rows;
...
DROP TABLE IF EXISTS kuu_banners;
...
DROP TABLE IF EXISTS kuu_banners_history;
...
DROP TABLE IF EXISTS kuu_categories;
...
DROP TABLE IF EXISTS kuu_categories_description;
...
DROP TABLE IF EXISTS kuu_configuration;
...
DROP TABLE IF EXISTS kuu_configuration_group;
...
DROP TABLE IF EXISTS kuu_counter;
CREATE TABLE kuu_counter (
  startdate datetime,
  counter int unsigned
) ENGINE=MyISAM CHARACTER SET utf8 COLLATE utf8_general_ci;

DROP TABLE IF EXISTS kuu_countries;
...
DROP TABLE IF EXISTS kuu_credit_cards;
...
DROP TABLE IF EXISTS kuu_currencies;
...
DROP TABLE IF EXISTS kuu_customers;
...
DROP TABLE IF EXISTS kuu_fk_relationships;
...
DROP TABLE IF EXISTS kuu_geo_zones;
...
DROP TABLE IF EXISTS kuu_languages;
...
DROP TABLE IF EXISTS kuu_languages_definitions;
...
DROP TABLE IF EXISTS kuu_manufacturers;
...
DROP TABLE IF EXISTS kuu_manufacturers_info;
...
DROP TABLE IF EXISTS kuu_modules;
...
DROP TABLE IF EXISTS kuu_newsletters;
...
DROP TABLE IF EXISTS kuu_newsletters_log;
...
DROP TABLE IF EXISTS kuu_orders;
...
DROP TABLE IF EXISTS kuu_orders_products;
...
DROP TABLE IF EXISTS kuu_orders_products_download;
...
DROP TABLE IF EXISTS kuu_orders_products_variants;
...
DROP TABLE IF EXISTS kuu_orders_status;
...
DROP TABLE IF EXISTS kuu_orders_status_history;
...
DROP TABLE IF EXISTS kuu_orders_total;
...
DROP TABLE IF EXISTS kuu_orders_transactions_history;
...
DROP TABLE IF EXISTS kuu_orders_transactions_status;
...
DROP TABLE IF EXISTS kuu_product_attributes;
...
DROP TABLE IF EXISTS kuu_product_types;
...
DROP TABLE IF EXISTS kuu_product_types_assignments;
...
DROP TABLE IF EXISTS kuu_products;
...
DROP TABLE IF EXISTS kuu_products_description;
...
DROP TABLE IF EXISTS kuu_products_images;
...
DROP TABLE IF EXISTS kuu_products_images_groups;
...
DROP TABLE IF EXISTS kuu_products_notifications;
...
DROP TABLE IF EXISTS kuu_products_to_categories;
...
DROP TABLE IF EXISTS kuu_products_variants;
...
DROP TABLE IF EXISTS kuu_products_variants_groups;
...
DROP TABLE IF EXISTS kuu_products_variants_values;
...
DROP TABLE IF EXISTS kuu_reviews;
...
DROP TABLE IF EXISTS kuu_sessions;
...
DROP TABLE IF EXISTS kuu_shipping_availability;
...
DROP TABLE IF EXISTS kuu_shopping_carts;
...
DROP TABLE IF EXISTS kuu_shopping_carts_custom_variants_values;
...
DROP TABLE IF EXISTS kuu_specials;
...
DROP TABLE IF EXISTS kuu_tax_class;
...
DROP TABLE IF EXISTS kuu_tax_rates;
...
DROP TABLE IF EXISTS kuu_templates;
...
DROP TABLE IF EXISTS kuu_templates_boxes;
...
DROP TABLE IF EXISTS kuu_templates_boxes_to_pages;
...
DROP TABLE IF EXISTS kuu_weight_classes;
...
DROP TABLE IF EXISTS kuu_weight_classes_rules;
...
DROP TABLE IF EXISTS kuu_whos_online;
...
DROP TABLE IF EXISTS kuu_zones;
...
DROP TABLE IF EXISTS kuu_zones_to_geo_zones;
...
INSERT INTO kuu_configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, use_function, set_function, date_added) VALUES ('Country', 'STORE_COUNTRY', '223', 'The country my store is located in <br><br><b>Note: Please remember to update the store zone.</b>', '1', '6', 'Kuuzu\\KU\\Core\\Site\\Shop\\Address::getCountryName', 'kuu_cfg_set_countries_pulldown_menu', now());
INSERT INTO kuu_configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, use_function, set_function, date_added) VALUES ('Zone', 'STORE_ZONE', '4031', 'The zone my store is located in', '1', '7', 'Kuuzu\\KU\\Core\\Site\\Shop\\Address::getZoneName', 'kuu_cfg_set_zones_pulldown_menu', now());
...
INSERT INTO kuu_configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Store Address and Phone', 'STORE_NAME_ADDRESS', 'Store Name\nAddress\nCountry\nPhone', 'This is the Store Name, Address and Phone used on printable documents and displayed online', '1', '18', 'kuu_cfg_set_textarea_field', now());
...
INSERT INTO kuu_configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, use_function, set_function, date_added) VALUES ('Country of Origin', 'SHIPPING_ORIGIN_COUNTRY', '223', 'Select the country of origin to be used in shipping quotes.', '7', '1', 'Kuuzu\\KU\\Core\\Site\\Shop\\Address::getCountryName', 'kuu_cfg_set_countries_pulldown_menu', now());
...
INSERT INTO kuu_configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Expiry delay (days)' ,'DOWNLOAD_MAX_DAYS', '7', 'Set number of days before the download link expires. 0 means no limit.', '13', '3', '', now());
...
INSERT INTO kuu_countries VALUES (1,'Afghanistan','AF','AFG','');
...
INSERT INTO kuu_countries VALUES (2,'Albania','AL','ALB','');
...
INSERT INTO kuu_countries VALUES (3,'Algeria','DZ','DZA','');
...
INSERT INTO kuu_countries VALUES (4,'American Samoa','AS','ASM','');
...
INSERT INTO kuu_countries VALUES (5,'Andorra','AD','AND','');
...
INSERT INTO kuu_countries VALUES (6,'Angola','AO','AGO','');
...
INSERT INTO kuu_countries VALUES (7,'Anguilla','AI','AIA','');
INSERT INTO kuu_countries VALUES (8,'Antarctica','AQ','ATA','');

INSERT INTO kuu_countries VALUES (9,'Antigua and Barbuda','AG','ATG','');
...
INSERT INTO kuu_countries VALUES (10,'Argentina','AR','ARG',":name\n:street_address\n:postcode :city\n:country");
...
INSERT INTO kuu_countries VALUES (11,'Armenia','AM','ARM','');
...
INSERT INTO kuu_countries VALUES (12,'Aruba','AW','ABW','');

INSERT INTO kuu_countries VALUES (13,'Australia','AU','AUS',":name\n:street_address\n:suburb :state_code :postcode\n:country");
...
INSERT INTO kuu_countries VALUES (14,'Austria','AT','AUT',":name\n:street_address\nA-:postcode :city\n:country");
...
INSERT INTO kuu_countries VALUES (15,'Azerbaijan','AZ','AZE','');
...
INSERT INTO kuu_countries VALUES (16,'Bahamas','BS','BHS','');
...
INSERT INTO kuu_countries VALUES (17,'Bahrain','BH','BHR','');
...
INSERT INTO kuu_countries VALUES (18,'Bangladesh','BD','BGD','');
...
INSERT INTO kuu_countries VALUES (19,'Barbados','BB','BRB','');
...
INSERT INTO kuu_countries VALUES (20,'Belarus','BY','BLR','');
...
INSERT INTO kuu_countries VALUES (21,'Belgium','BE','BEL',":name\n:street_address\nB-:postcode :city\n:country");
...
INSERT INTO kuu_countries VALUES (22,'Belize','BZ','BLZ','');
...
INSERT INTO kuu_countries VALUES (23,'Benin','BJ','BEN','');
...
INSERT INTO kuu_countries VALUES (24,'Bermuda','BM','BMU','');
...
INSERT INTO kuu_countries VALUES (25,'Bhutan','BT','BTN','');
...
INSERT INTO kuu_countries VALUES (26,'Bolivia','BO','BOL','');
...
INSERT INTO kuu_countries VALUES (27,'Bosnia and Herzegowina','BA','BIH','');
INSERT INTO kuu_countries VALUES (28,'Botswana','BW','BWA','');
...
INSERT INTO kuu_countries VALUES (29,'Bouvet Island','BV','BVT','');

INSERT INTO kuu_countries VALUES (30,'Brazil','BR','BRA',":name\n:street_address\n:state\n:postcode\n:country");
...
INSERT INTO kuu_countries VALUES (31,'British Indian Ocean Territory','IO','IOT','');
...
INSERT INTO kuu_countries VALUES (32,'Brunei Darussalam','BN','BRN','');
...
INSERT INTO kuu_countries VALUES (33,'Bulgaria','BG','BGR','');
...
INSERT INTO kuu_countries VALUES (34,'Burkina Faso','BF','BFA','');
...
INSERT INTO kuu_countries VALUES (35,'Burundi','BI','BDI','');
...
INSERT INTO kuu_countries VALUES (36,'Cambodia','KH','KHM','');

INSERT INTO kuu_countries VALUES (37,'Cameroon','CM','CMR','');
...
INSERT INTO kuu_countries VALUES (38,'Canada','CA','CAN',":name\n:street_address\n:city :state_code :postcode\n:country");
...
INSERT INTO kuu_countries VALUES (39,'Cape Verde','CV','CPV','');
...
INSERT INTO kuu_countries VALUES (40,'Cayman Islands','KY','CYM','');
...
INSERT INTO kuu_countries VALUES (41,'Central African Republic','CF','CAF','');
...
INSERT INTO kuu_countries VALUES (42,'Chad','TD','TCD','');
...
INSERT INTO kuu_countries VALUES (43,'Chile','CL','CHL',":name\n:street_address\n:city\n:country");
...
INSERT INTO kuu_countries VALUES (44,'China','CN','CHN',":name\n:street_address\n:postcode :city\n:country");
...
INSERT INTO kuu_countries VALUES (45,'Christmas Island','CX','CXR','');

INSERT INTO kuu_countries VALUES (46,'Cocos (Keeling) Islands','CC','CCK','');
...
INSERT INTO kuu_countries VALUES (47,'Colombia','CO','COL','');
...
INSERT INTO kuu_countries VALUES (48,'Comoros','KM','COM','');
...
INSERT INTO kuu_countries VALUES (49,'Congo','CG','COG','');
...
INSERT INTO kuu_countries VALUES (50,'Cook Islands','CK','COK','');
...
INSERT INTO kuu_countries VALUES (51,'Costa Rica','CR','CRI','');
...
INSERT INTO kuu_countries VALUES (52,'Cote D\'Ivoire','CI','CIV','');
...
INSERT INTO kuu_countries VALUES (53,'Croatia','HR','HRV','');
...
INSERT INTO kuu_countries VALUES (54,'Cuba','CU','CUB','');
...
INSERT INTO kuu_countries VALUES (55,'Cyprus','CY','CYP','');
...
INSERT INTO kuu_countries VALUES (56,'Czech Republic','CZ','CZE','');
...
INSERT INTO kuu_countries VALUES (57,'Denmark','DK','DNK',":name\n:street_address\nDK-:postcode :city\n:country");
...
INSERT INTO kuu_countries VALUES (58,'Djibouti','DJ','DJI','');
...
INSERT INTO kuu_countries VALUES (59,'Dominica','DM','DMA','');
...
INSERT INTO kuu_countries VALUES (60,'Dominican Republic','DO','DOM','');
...
INSERT INTO kuu_countries VALUES (61,'East Timor','TP','TMP','');
...
INSERT INTO kuu_countries VALUES (62,'Ecuador','EC','ECU','');
...
INSERT INTO kuu_countries VALUES (63,'Egypt','EG','EGY','');
...
INSERT INTO kuu_countries VALUES (64,'El Salvador','SV','SLV','');
...
INSERT INTO kuu_countries VALUES (65,'Equatorial Guinea','GQ','GNQ','');
...
INSERT INTO kuu_countries VALUES (66,'Eritrea','ER','ERI','');
...
INSERT INTO kuu_countries VALUES (67,'Estonia','EE','EST','');
...
INSERT INTO kuu_countries VALUES (68,'Ethiopia','ET','ETH','');
...
INSERT INTO kuu_countries VALUES (69,'Falkland Islands (Malvinas)','FK','FLK','');
INSERT INTO kuu_countries VALUES (70,'Faroe Islands','FO','FRO','');

INSERT INTO kuu_countries VALUES (71,'Fiji','FJ','FJI','');
...
INSERT INTO kuu_countries VALUES (72,'Finland','FI','FIN',":name\n:street_address\nFIN-:postcode :city\n:country");
...
INSERT INTO kuu_countries VALUES (73,'France','FR','FRA',":name\n:street_address\n:postcode :city\n:country");
...
INSERT INTO kuu_countries VALUES (74,'France, Metropolitan','FX','FXX',":name\n:street_address\n:postcode :city\n:country");
INSERT INTO kuu_countries VALUES (75,'French Guiana','GF','GUF',":name\n:street_address\n:postcode :city\n:country");
INSERT INTO kuu_countries VALUES (76,'French Polynesia','PF','PYF',":name\n:street_address\n:postcode :city\n:country");
...
INSERT INTO kuu_countries VALUES (77,'French Southern Territories','TF','ATF',":name\n:street_address\n:postcode :city\n:country");
...
INSERT INTO kuu_countries VALUES (78,'Gabon','GA','GAB','');
...
INSERT INTO kuu_countries VALUES (79,'Gambia','GM','GMB','');
...
INSERT INTO kuu_countries VALUES (80,'Georgia','GE','GEO','');
...
INSERT INTO kuu_countries VALUES (81,'Germany','DE','DEU',":name\n:street_address\nD-:postcode :city\n:country");
...
INSERT INTO kuu_countries VALUES (82,'Ghana','GH','GHA','');
...
INSERT INTO kuu_countries VALUES (83,'Gibraltar','GI','GIB','');

INSERT INTO kuu_countries VALUES (84,'Greece','GR','GRC','');
...
INSERT INTO kuu_countries VALUES (85,'Greenland','GL','GRL',":name\n:street_address\nDK-:postcode :city\n:country");
...
INSERT INTO kuu_countries VALUES (86,'Grenada','GD','GRD','');
...
INSERT INTO kuu_countries VALUES (87,'Guadeloupe','GP','GLP','');
INSERT INTO kuu_countries VALUES (88,'Guam','GU','GUM','');

INSERT INTO kuu_countries VALUES (89,'Guatemala','GT','GTM','');
...
INSERT INTO kuu_countries VALUES (90,'Guinea','GN','GIN','');
...
INSERT INTO kuu_countries VALUES (91,'Guinea-Bissau','GW','GNB','');
...
INSERT INTO kuu_countries VALUES (92,'Guyana','GY','GUY','');
...
INSERT INTO kuu_countries VALUES (93,'Haiti','HT','HTI','');
...
INSERT INTO kuu_countries VALUES (94,'Heard and McDonald Islands','HM','HMD','');
...
INSERT INTO kuu_countries VALUES (95,'Honduras','HN','HND','');
...
INSERT INTO kuu_countries VALUES (96,'Hong Kong','HK','HKG',":name\n:street_address\n:city\n:country");
...
INSERT INTO kuu_countries VALUES (97,'Hungary','HU','HUN','');
...
INSERT INTO kuu_countries VALUES (98,'Iceland','IS','ISL',":name\n:street_address\nIS:postcode :city\n:country");
...
INSERT INTO kuu_countries VALUES (99,'India','IN','IND',":name\n:street_address\n:city-:postcode\n:country");
...
INSERT INTO kuu_countries VALUES (100,'Indonesia','ID','IDN',":name\n:street_address\n:city :postcode\n:country");
...
INSERT INTO kuu_countries VALUES (101,'Iran','IR','IRN','');
...
INSERT INTO kuu_countries VALUES (102,'Iraq','IQ','IRQ','');
...
INSERT INTO kuu_countries VALUES (103,'Ireland','IE','IRL',":name\n:street_address\nIE-:city\n:country");
...
INSERT INTO kuu_countries VALUES (104,'Israel','IL','ISR',":name\n:street_address\n:postcode :city\n:country");
...
INSERT INTO kuu_countries VALUES (105,'Italy','IT','ITA',":name\n:street_address\n:postcode-:city :state_code\n:country");
...
INSERT INTO kuu_countries VALUES (106,'Jamaica','JM','JAM','');
...
INSERT INTO kuu_countries VALUES (107,'Japan','JP','JPN',":name\n:street_address, :suburb\n:city :postcode\n:country");
...
INSERT INTO kuu_countries VALUES (108,'Jordan','JO','JOR','');
...
INSERT INTO kuu_countries VALUES (109,'Kazakhstan','KZ','KAZ','');
...
INSERT INTO kuu_countries VALUES (110,'Kenya','KE','KEN','');
...
INSERT INTO kuu_countries VALUES (111,'Kiribati','KI','KIR','');
...
INSERT INTO kuu_countries VALUES (112,'Korea, North','KP','PRK','');
...
INSERT INTO kuu_countries VALUES (113,'Korea, South','KR','KOR','');
...
INSERT INTO kuu_countries VALUES (114,'Kuwait','KW','KWT','');
...
INSERT INTO kuu_countries VALUES (115,'Kyrgyzstan','KG','KGZ','');
...
INSERT INTO kuu_countries VALUES (116,'Laos','LA','LAO','');
...
INSERT INTO kuu_countries VALUES (117,'Latvia','LV','LVA','');
...
INSERT INTO kuu_countries VALUES (118,'Lebanon','LB','LBN','');

INSERT INTO kuu_countries VALUES (119,'Lesotho','LS','LSO','');
...
INSERT INTO kuu_countries VALUES (120,'Liberia','LR','LBR','');
...
INSERT INTO kuu_countries VALUES (121,'Libyan Arab Jamahiriya','LY','LBY','');
...
INSERT INTO kuu_countries VALUES (122,'Liechtenstein','LI','LIE','');
...
INSERT INTO kuu_countries VALUES (123,'Lithuania','LT','LTU','');
...
INSERT INTO kuu_countries VALUES (124,'Luxembourg','LU','LUX',":name\n:street_address\nL-:postcode :city\n:country");
...
INSERT INTO kuu_countries VALUES (125,'Macau','MO','MAC','');
...
INSERT INTO kuu_countries VALUES (126,'Macedonia','MK','MKD','');
...
INSERT INTO kuu_countries VALUES (127,'Madagascar','MG','MDG','');
...
INSERT INTO kuu_countries VALUES (128,'Malawi','MW','MWI','');
...
INSERT INTO kuu_countries VALUES (129,'Malaysia','MY','MYS','');
...
INSERT INTO kuu_countries VALUES (130,'Maldives','MV','MDV','');
...
INSERT INTO kuu_countries VALUES (131,'Mali','ML','MLI','');
...
INSERT INTO kuu_countries VALUES (132,'Malta','MT','MLT','');
...
INSERT INTO kuu_countries VALUES (133,'Marshall Islands','MH','MHL','');
...
INSERT INTO kuu_countries VALUES (134,'Martinique','MQ','MTQ','');

INSERT INTO kuu_countries VALUES (135,'Mauritania','MR','MRT','');
...
INSERT INTO kuu_countries VALUES (136,'Mauritius','MU','MUS','');
...
INSERT INTO kuu_countries VALUES (137,'Mayotte','YT','MYT','');

INSERT INTO kuu_countries VALUES (138,'Mexico','MX','MEX',":name\n:street_address\n:postcode :city, :state_code\n:country");
...
INSERT INTO kuu_countries VALUES (139,'Micronesia','FM','FSM','');
...
INSERT INTO kuu_countries VALUES (140,'Moldova','MD','MDA','');
...
INSERT INTO kuu_countries VALUES (141,'Monaco','MC','MCO','');
...
INSERT INTO kuu_countries VALUES (142,'Mongolia','MN','MNG','');
...
INSERT INTO kuu_countries VALUES (143,'Montserrat','MS','MSR','');
...
INSERT INTO kuu_countries VALUES (144,'Morocco','MA','MAR','');

INSERT INTO kuu_countries VALUES (145,'Mozambique','MZ','MOZ','');
...
INSERT INTO kuu_countries VALUES (146,'Myanmar','MM','MMR','');
...
INSERT INTO kuu_countries VALUES (147,'Namibia','NA','NAM','');
...
INSERT INTO kuu_countries VALUES (148,'Nauru','NR','NRU','');
...
INSERT INTO kuu_countries VALUES (149,'Nepal','NP','NPL','');
...
INSERT INTO kuu_countries VALUES (150,'Netherlands','NL','NLD',":name\n:street_address\n:postcode :city\n:country");
...
INSERT INTO kuu_countries VALUES (151,'Netherlands Antilles','AN','ANT',":name\n:street_address\n:postcode :city\n:country");

INSERT INTO kuu_countries VALUES (152,'New Caledonia','NC','NCL','');
...
INSERT INTO kuu_countries VALUES (153,'New Zealand','NZ','NZL',":name\n:street_address\n:suburb\n:city :postcode\n:country");
...
INSERT INTO kuu_countries VALUES (154,'Nicaragua','NI','NIC','');
...
INSERT INTO kuu_countries VALUES (155,'Niger','NE','NER','');
...
INSERT INTO kuu_countries VALUES (156,'Nigeria','NG','NGA','');
...
INSERT INTO kuu_countries VALUES (157,'Niue','NU','NIU','');
INSERT INTO kuu_countries VALUES (158,'Norfolk Island','NF','NFK','');

INSERT INTO kuu_countries VALUES (159,'Northern Mariana Islands','MP','MNP','');
...
INSERT INTO kuu_countries VALUES (160,'Norway','NO','NOR',":name\n:street_address\nNO-:postcode :city\n:country");
...
INSERT INTO kuu_countries VALUES (161,'Oman','OM','OMN','');
...
INSERT INTO kuu_countries VALUES (162,'Pakistan','PK','PAK','');
...
INSERT INTO kuu_countries VALUES (163,'Palau','PW','PLW','');
...
INSERT INTO kuu_countries VALUES (164,'Panama','PA','PAN','');
...
INSERT INTO kuu_countries VALUES (165,'Papua New Guinea','PG','PNG','');
...
INSERT INTO kuu_countries VALUES (166,'Paraguay','PY','PRY','');
...
INSERT INTO kuu_countries VALUES (167,'Peru','PE','PER','');
...
INSERT INTO kuu_countries VALUES (168,'Philippines','PH','PHL','');
...
INSERT INTO kuu_countries VALUES (169,'Pitcairn','PN','PCN','');

INSERT INTO kuu_countries VALUES (170,'Poland','PL','POL',":name\n:street_address\n:postcode :city\n:country");
...
INSERT INTO kuu_countries VALUES (171,'Portugal','PT','PRT',":name\n:street_address\n:postcode :city\n:country");
...
INSERT INTO kuu_countries VALUES (172,'Puerto Rico','PR','PRI','');

INSERT INTO kuu_countries VALUES (173,'Qatar','QA','QAT','');
...
INSERT INTO kuu_countries VALUES (174,'Reunion','RE','REU','');

INSERT INTO kuu_countries VALUES (175,'Romania','RO','ROM','');
...
INSERT INTO kuu_countries VALUES (176,'Russia','RU','RUS',":name\n:street_address\n:postcode :city\n:country");
...
INSERT INTO kuu_countries VALUES (177,'Rwanda','RW','RWA','');
...
INSERT INTO kuu_countries VALUES (178,'Saint Kitts and Nevis','KN','KNA','');
...
INSERT INTO kuu_countries VALUES (179,'Saint Lucia','LC','LCA','');
...
INSERT INTO kuu_countries VALUES (180,'Saint Vincent and the Grenadines','VC','VCT','');
...
INSERT INTO kuu_countries VALUES (181,'Samoa','WS','WSM','');
...
INSERT INTO kuu_countries VALUES (182,'San Marino','SM','SMR','');
...
INSERT INTO kuu_countries VALUES (183,'Sao Tome and Principe','ST','STP','');
...
INSERT INTO kuu_countries VALUES (184,'Saudi Arabia','SA','SAU','');
...
INSERT INTO kuu_countries VALUES (185,'Senegal','SN','SEN','');
...
INSERT INTO kuu_countries VALUES (186,'Seychelles','SC','SYC','');
...
INSERT INTO kuu_countries VALUES (187,'Sierra Leone','SL','SLE','');
...
INSERT INTO kuu_countries VALUES (188,'Singapore','SG','SGP', ":name\n:street_address\n:city :postcode\n:country");

INSERT INTO kuu_countries VALUES (189,'Slovakia','SK','SVK','');
...
INSERT INTO kuu_countries VALUES (190,'Slovenia','SI','SVN','');
...
INSERT INTO kuu_countries VALUES (191,'Solomon Islands','SB','SLB','');
...
INSERT INTO kuu_countries VALUES (192,'Somalia','SO','SOM','');
...
INSERT INTO kuu_countries VALUES (193,'South Africa','ZA','ZAF',":name\n:street_address\n:suburb\n:city\n:postcode :country");
...
INSERT INTO kuu_countries VALUES (194,'South Georgia and the South Sandwich Islands','GS','SGS','');

INSERT INTO kuu_countries VALUES (195,'Spain','ES','ESP',":name\n:street_address\n:postcode :city\n:country");
...
INSERT INTO kuu_countries VALUES (196,'Sri Lanka','LK','LKA','');
...
INSERT INTO kuu_countries VALUES (197,'St. Helena','SH','SHN','');
INSERT INTO kuu_countries VALUES (198,'St. Pierre and Miquelon','PM','SPM','');

INSERT INTO kuu_countries VALUES (199,'Sudan','SD','SDN','');
...
INSERT INTO kuu_countries VALUES (200,'Suriname','SR','SUR','');
...
INSERT INTO kuu_countries VALUES (201,'Svalbard and Jan Mayen Islands','SJ','SJM','');

INSERT INTO kuu_countries VALUES (202,'Swaziland','SZ','SWZ','');
...
INSERT INTO kuu_countries VALUES (203,'Sweden','SE','SWE',":name\n:street_address\n:postcode :city\n:country");
...
INSERT INTO kuu_countries VALUES (204,'Switzerland','CH','CHE',":name\n:street_address\n:postcode :city\n:country");
...
INSERT INTO kuu_countries VALUES (205,'Syrian Arab Republic','SY','SYR','');
...
INSERT INTO kuu_countries VALUES (206,'Taiwan','TW','TWN',":name\n:street_address\n:city :postcode\n:country");
...
INSERT INTO kuu_countries VALUES (207,'Tajikistan','TJ','TJK','');
...
INSERT INTO kuu_countries VALUES (208,'Tanzania','TZ','TZA','');
...
INSERT INTO kuu_countries VALUES (209,'Thailand','TH','THA','');
...
INSERT INTO kuu_countries VALUES (210,'Togo','TG','TGO','');
...
INSERT INTO kuu_countries VALUES (211,'Tokelau','TK','TKL','');
...
INSERT INTO kuu_countries VALUES (212,'Tonga','TO','TON','');
...
INSERT INTO kuu_countries VALUES (213,'Trinidad and Tobago','TT','TTO','');
...
INSERT INTO kuu_countries VALUES (214,'Tunisia','TN','TUN','');
...
INSERT INTO kuu_countries VALUES (215,'Turkey','TR','TUR','');
...
INSERT INTO kuu_countries VALUES (216,'Turkmenistan','TM','TKM','');
...
INSERT INTO kuu_countries VALUES (217,'Turks and Caicos Islands','TC','TCA','');
...
INSERT INTO kuu_countries VALUES (218,'Tuvalu','TV','TUV','');
...
INSERT INTO kuu_countries VALUES (219,'Uganda','UG','UGA','');
...
INSERT INTO kuu_countries VALUES (220,'Ukraine','UA','UKR','');
...
INSERT INTO kuu_countries VALUES (221,'United Arab Emirates','AE','ARE','');

INSERT INTO kuu_countries VALUES (222,'United Kingdom','GB','GBR',":name\n:street_address\n:city\n:postcode\n:country");
...
INSERT INTO kuu_countries VALUES (223,'United States of America','US','USA',":name\n:street_address\n:city :state_code :postcode\n:country");
...
INSERT INTO kuu_countries VALUES (224,'United States Minor Outlying Islands','UM','UMI','');
...
INSERT INTO kuu_countries VALUES (225,'Uruguay','UY','URY','');
...
INSERT INTO kuu_countries VALUES (226,'Uzbekistan','UZ','UZB','');
...
INSERT INTO kuu_countries VALUES (227,'Vanuatu','VU','VUT','');
...
INSERT INTO kuu_countries VALUES (228,'Vatican City State (Holy See)','VA','VAT','');

INSERT INTO kuu_countries VALUES (229,'Venezuela','VE','VEN','');
...
INSERT INTO kuu_countries VALUES (230,'Vietnam','VN','VNM','');
...
INSERT INTO kuu_countries VALUES (231,'Virgin Islands (British)','VG','VGB','');
INSERT INTO kuu_countries VALUES (232,'Virgin Islands (U.S.)','VI','VIR','');
...
INSERT INTO kuu_countries VALUES (233,'Wallis and Futuna Islands','WF','WLF','');
...
INSERT INTO kuu_countries VALUES (234,'Western Sahara','EH','ESH','');
INSERT INTO kuu_countries VALUES (235,'Yemen','YE','YEM','');
...
INSERT INTO kuu_countries VALUES (236,'Yugoslavia','YU','YUG','');
INSERT INTO kuu_countries VALUES (237,'Zaire','ZR','ZAR','');

INSERT INTO kuu_countries VALUES (238,'Zambia','ZM','ZMB','');
...
INSERT INTO kuu_countries VALUES (239,'Zimbabwe','ZW','ZWE','');
...
INSERT INTO kuu_credit_cards VALUES (1,'American Express','/^(34|37)\\d{13}$/','0','0');
INSERT INTO kuu_credit_cards VALUES (2,'Diners Club','/^(30|36|38)\\d{12}$/','0','0');
INSERT INTO kuu_credit_cards VALUES (3,'JCB','/^((2131|1800)\\d{11}|3[0135]\\d{14})$/','0','0');
INSERT INTO kuu_credit_cards VALUES (4,'MasterCard','/^5[1-5]\\d{14}$/','1','0');
INSERT INTO kuu_credit_cards VALUES (5,'Visa','/^4\\d{12}(\\d{3})?$/','1','0');
INSERT INTO kuu_credit_cards VALUES (6,'Discover Card','/^6011\\d{12}$/','0','0');
INSERT INTO kuu_credit_cards VALUES (7,'Solo','/^(63|67)\\d{14}(\\d{2,3})?$/','0','0');
INSERT INTO kuu_credit_cards VALUES (8,'Switch','/^(49|56|63|67)\\d{14}(\\d{2,3})?$/','0','0');
INSERT INTO kuu_credit_cards VALUES (9,'Australian Bankcard','/^5610\\d{12}$/','0','0');
INSERT INTO kuu_credit_cards VALUES (10,'enRoute','/^(2014|2149)\\d{11}$/','0','0');
INSERT INTO kuu_credit_cards VALUES (11,'Laser','/^6304\\d{12}(\\d{2,3})?$/','0','0');
INSERT INTO kuu_credit_cards VALUES (12,'Maestro','/^(50|56|57|58|6)/','0','0');
INSERT INTO kuu_credit_cards VALUES (13,'Saferpay Test Card','/^9451123100000004$/','0','0');

INSERT INTO kuu_currencies VALUES (1,'US Dollar','USD','$','','2','1.0000', now());
INSERT INTO kuu_currencies VALUES (2,'Euro','EUR','€','','2','1.2076', now());
INSERT INTO kuu_currencies VALUES (3,'British Pounds','GBP','£','','2','1.7587', now());

INSERT INTO kuu_languages VALUES (1,'English','en_US','en_US.UTF-8,en_US,english','utf-8','%m/%d/%Y','%A %d %B, %Y','%H:%M:%S','ltr',1,'.',',',0,1);
...
INSERT INTO kuu_product_types values (1, 'Shippable');
INSERT INTO kuu_product_types_assignments values (1, 1, 'PerformOrder', 'RequireShipping', 100);
INSERT INTO kuu_product_types_assignments values (2, 1, 'PerformOrder', 'RequireBilling', 200);
...
INSERT INTO kuu_tax_class VALUES (1, 'Taxable Goods', 'The following types of products are included non-food, services, etc', now(), now());

# USA/Florida
INSERT INTO kuu_tax_rates VALUES (1, 1, 1, 1, 7.0, 'FL TAX 7.0%', now(), now());
INSERT INTO kuu_geo_zones (geo_zone_id,geo_zone_name,geo_zone_description,date_added) VALUES (1,"Florida","Florida local sales tax zone",now());
INSERT INTO kuu_zones_to_geo_zones (association_id,zone_country_id,zone_id,geo_zone_id,date_added) VALUES (1,223,4031,1,now());

# Templates

INSERT INTO kuu_templates VALUES (1, 'Kuuzu Online Store', 'kuuzu', 'Kuuzu', 'https://kuuzu.org', 'XHTML 1.0 Transitional', 1, 'Screen');

INSERT INTO kuu_templates_boxes VALUES (1, 'Best Sellers', 'BestSellers', 'Kuuzu', 'https://kuuzu.org', 'Box');
INSERT INTO kuu_templates_boxes VALUES (2, 'Categories', 'Categories', 'Kuuzu', 'https://kuuzu.org', 'Box');
INSERT INTO kuu_templates_boxes VALUES (3, 'Currencies', 'Currencies', 'Kuuzu', 'https://kuuzu.org', 'Box');
INSERT INTO kuu_templates_boxes VALUES (4, 'Information', 'Information', 'Kuuzu', 'https://kuuzu.org', 'Box');
INSERT INTO kuu_templates_boxes VALUES (5, 'Languages', 'Languages', 'Kuuzu', 'https://kuuzu.org', 'Box');
INSERT INTO kuu_templates_boxes VALUES (6, 'Manufacturer Info', 'ManufacturerInfo', 'Kuuzu', 'https://kuuzu.org', 'Box');
INSERT INTO kuu_templates_boxes VALUES (7, 'Manufacturers', 'Manufacturers', 'Kuuzu', 'https://kuuzu.org', 'Box');
INSERT INTO kuu_templates_boxes VALUES (8, 'Order History', 'OrderHistory', 'Kuuzu', 'https://kuuzu.org', 'Box');
INSERT INTO kuu_templates_boxes VALUES (9, 'Product Notifications', 'ProductNotifications', 'Kuuzu', 'https://kuuzu.org', 'Box');
INSERT INTO kuu_templates_boxes VALUES (10, 'Reviews', 'Reviews', 'Kuuzu', 'https://kuuzu.org', 'Box');
INSERT INTO kuu_templates_boxes VALUES (11, 'Search', 'Search', 'Kuuzu', 'https://kuuzu.org', 'Box');
INSERT INTO kuu_templates_boxes VALUES (12, 'Shopping Cart', 'ShoppingCart', 'Kuuzu', 'https://kuuzu.org', 'Box');
INSERT INTO kuu_templates_boxes VALUES (13, 'Specials', 'Specials', 'Kuuzu', 'https://kuuzu.org', 'Box');
INSERT INTO kuu_templates_boxes VALUES (14, 'Tell a Friend', 'TellAFriend', 'Kuuzu', 'https://kuuzu.org', 'Box');
INSERT INTO kuu_templates_boxes VALUES (15, 'What\'s New', 'WhatsNew', 'Kuuzu', 'https://kuuzu.org', 'Box');
INSERT INTO kuu_templates_boxes VALUES (16, 'New Products', 'NewProducts', 'Kuuzu', 'https://kuuzu.org', 'Content');
INSERT INTO kuu_templates_boxes VALUES (17, 'Upcoming Products', 'UpcomingProducts', 'Kuuzu', 'https://kuuzu.org', 'Content');
INSERT INTO kuu_templates_boxes VALUES (18, 'Recently Visited', 'RecentlyVisited', 'Kuuzu', 'https://kuuzu.org', 'Content');
INSERT INTO kuu_templates_boxes VALUES (19, 'Also Purchased Products', 'AlsoPurchasedProducts', 'Kuuzu', 'https://kuuzu.org', 'Content');
INSERT INTO kuu_templates_boxes VALUES (20, 'Date Available', 'DateAvailable', 'Kuuzu', 'https://kuuzu.org', 'ProductAttribute');
INSERT INTO kuu_templates_boxes VALUES (21, 'Manufacturers', 'Manufacturers', 'Kuuzu', 'https://kuuzu.org', 'ProductAttribute');

INSERT INTO kuu_templates_boxes_to_pages VALUES (1, 2, 1, '*', 'left', 100, 0);
INSERT INTO kuu_templates_boxes_to_pages VALUES (2, 7, 1, '*', 'left', 200, 0);
INSERT INTO kuu_templates_boxes_to_pages VALUES (3, 15, 1, '*', 'left', 300, 0);
INSERT INTO kuu_templates_boxes_to_pages VALUES (4, 11, 1, '*', 'left', 400, 0);
INSERT INTO kuu_templates_boxes_to_pages VALUES (5, 4, 1, '*', 'left', 500, 0);
INSERT INTO kuu_templates_boxes_to_pages VALUES (6, 12, 1, '*', 'right', 100, 0);
INSERT INTO kuu_templates_boxes_to_pages VALUES (7, 6, 1, 'Products/main', 'right', 200, 0);
INSERT INTO kuu_templates_boxes_to_pages VALUES (8, 8, 1, '*', 'right', 300, 0);
INSERT INTO kuu_templates_boxes_to_pages VALUES (9, 1, 1, '*', 'right', 400, 0);
INSERT INTO kuu_templates_boxes_to_pages VALUES (10, 9, 1, 'Products/main', 'right', 500, 0);
INSERT INTO kuu_templates_boxes_to_pages VALUES (11, 14, 1, 'Products/main','right', 600, 0);
INSERT INTO kuu_templates_boxes_to_pages VALUES (12, 13, 1, '*', 'right', 700, 0);
INSERT INTO kuu_templates_boxes_to_pages VALUES (13, 10, 1, '*', 'right', 800, 0);
INSERT INTO kuu_templates_boxes_to_pages VALUES (14, 5, 1, '*', 'right', 900, 0);
INSERT INTO kuu_templates_boxes_to_pages VALUES (15, 3, 1, '*', 'right', 1000, 0);
INSERT INTO kuu_templates_boxes_to_pages VALUES (16, 16, 1, 'Index/category_listing', 'after', 400, 0);
INSERT INTO kuu_templates_boxes_to_pages VALUES (17, 16, 1, 'Index/main','after', 400, 0);
INSERT INTO kuu_templates_boxes_to_pages VALUES (18, 17, 1, 'Index/main','after', 450, 0);
INSERT INTO kuu_templates_boxes_to_pages VALUES (19, 18, 1, '*', 'after', 500, 0);
INSERT INTO kuu_templates_boxes_to_pages VALUES (20, 19, 1, 'Products/main', 'after', 100, 0);
...
INSERT INTO kuu_fk_relationships VALUES (null, 'address_book', 'customers', 'customers_id', 'customers_id', 'cascade', 'cascade');
INSERT INTO kuu_fk_relationships VALUES (null, 'address_book', 'countries', 'entry_country_id', 'countries_id', 'cascade', 'cascade');
INSERT INTO kuu_fk_relationships VALUES (null, 'address_book', 'zones', 'entry_zone_id', 'zone_id', 'cascade', 'set_null');
INSERT INTO kuu_fk_relationships VALUES (null, 'administrators_access', 'administrators', 'administrators_id', 'id', 'cascade', 'cascade');
INSERT INTO kuu_fk_relationships VALUES (null, 'audit_log_rows', 'audit_log', 'audit_log_id', 'id', 'cascade', 'cascade');
INSERT INTO kuu_fk_relationships VALUES (null, 'banners_history', 'banners', 'banners_id', 'banners_id', 'cascade', 'cascade');
INSERT INTO kuu_fk_relationships VALUES (null, 'categories', 'categories', 'parent_id', 'categories_id', 'cascade', 'cascade');
INSERT INTO kuu_fk_relationships VALUES (null, 'categories_description', 'categories', 'categories_id', 'categories_id', 'cascade', 'cascade');
INSERT INTO kuu_fk_relationships VALUES (null, 'categories_description', 'languages', 'language_id', 'languages_id', 'cascade', 'cascade');
INSERT INTO kuu_fk_relationships VALUES (null, 'configuration', 'configuration_group', 'configuration_group_id', 'configuration_group_id', 'cascade', 'cascade');
INSERT INTO kuu_fk_relationships VALUES (null, 'customers', 'address_book', 'customers_default_address_id', 'address_book_id', 'cascade', 'set_null');
INSERT INTO kuu_fk_relationships VALUES (null, 'languages', 'currencies', 'currencies_id', 'currencies_id', 'cascade', 'restrict');
INSERT INTO kuu_fk_relationships VALUES (null, 'languages_definitions', 'languages', 'languages_id', 'languages_id', 'cascade', 'cascade');
INSERT INTO kuu_fk_relationships VALUES (null, 'manufacturers_info', 'manufacturers', 'manufacturers_id', 'manufacturers_id', 'cascade', 'cascade');
INSERT INTO kuu_fk_relationships VALUES (null, 'manufacturers_info', 'languages', 'languages_id', 'languages_id', 'cascade', 'cascade');
INSERT INTO kuu_fk_relationships VALUES (null, 'newsletters_log', 'newsletters', 'newsletters_id', 'newsletters_id', 'cascade', 'cascade');
INSERT INTO kuu_fk_relationships VALUES (null, 'orders', 'orders_status', 'orders_status', 'orders_status_id', 'cascade', 'restrict');
INSERT INTO kuu_fk_relationships VALUES (null, 'orders_products', 'orders', 'orders_id', 'orders_id', 'cascade', 'cascade');
INSERT INTO kuu_fk_relationships VALUES (null, 'orders_products_download', 'orders', 'orders_id', 'orders_id', 'cascade', 'cascade');
INSERT INTO kuu_fk_relationships VALUES (null, 'orders_products_variants', 'orders', 'orders_id', 'orders_id', 'cascade', 'cascade');
INSERT INTO kuu_fk_relationships VALUES (null, 'orders_status', 'languages', 'language_id', 'languages_id', 'cascade', 'cascade');
INSERT INTO kuu_fk_relationships VALUES (null, 'orders_status_history', 'orders', 'orders_id', 'orders_id', 'cascade', 'cascade');
INSERT INTO kuu_fk_relationships VALUES (null, 'orders_status_history', 'orders_status', 'orders_status_id', 'orders_status_id', 'cascade', 'restrict');
INSERT INTO kuu_fk_relationships VALUES (null, 'orders_total', 'orders', 'orders_id', 'orders_id', 'cascade', 'cascade');
INSERT INTO kuu_fk_relationships VALUES (null, 'orders_transactions_history', 'orders', 'orders_id', 'orders_id', 'cascade', 'cascade');
INSERT INTO kuu_fk_relationships VALUES (null, 'orders_transactions_status', 'languages', 'language_id', 'languages_id', 'cascade', 'cascade');
INSERT INTO kuu_fk_relationships VALUES (null, 'product_attributes', 'products', 'products_id', 'products_id', 'cascade', 'cascade');
INSERT INTO kuu_fk_relationships VALUES (null, 'product_attributes', 'languages', 'languages_id', 'languages_id', 'cascade', 'cascade');
INSERT INTO kuu_fk_relationships VALUES (null, 'product_types_assignments', 'product_types', 'types_id', 'id', 'cascade', 'cascade');
INSERT INTO kuu_fk_relationships VALUES (null, 'products', 'products', 'parent_id', 'products_id', 'cascade', 'cascade');
INSERT INTO kuu_fk_relationships VALUES (null, 'products', 'weight_classes', 'products_weight_class', 'weight_class_id', 'cascade', 'restrict');
INSERT INTO kuu_fk_relationships VALUES (null, 'products', 'tax_class', 'products_tax_class_id', 'tax_class_id', 'cascade', 'set_null');
INSERT INTO kuu_fk_relationships VALUES (null, 'products', 'manufacturers', 'manufacturers_id', 'manufacturers_id', 'cascade', 'set_null');
INSERT INTO kuu_fk_relationships VALUES (null, 'products', 'product_types', 'products_types_id', 'id', 'cascade', 'set_null');
INSERT INTO kuu_fk_relationships VALUES (null, 'products_description', 'products', 'products_id', 'products_id', 'cascade', 'cascade');
INSERT INTO kuu_fk_relationships VALUES (null, 'products_description', 'languages', 'language_id', 'languages_id', 'cascade', 'cascade');
INSERT INTO kuu_fk_relationships VALUES (null, 'products_images', 'products', 'products_id', 'products_id', 'cascade', 'cascade');
INSERT INTO kuu_fk_relationships VALUES (null, 'products_images_groups', 'languages', 'language_id', 'languages_id', 'cascade', 'cascade');
INSERT INTO kuu_fk_relationships VALUES (null, 'products_notifications', 'products', 'products_id', 'products_id', 'cascade', 'cascade');
INSERT INTO kuu_fk_relationships VALUES (null, 'products_notifications', 'customers', 'customers_id', 'customers_id', 'cascade', 'cascade');
INSERT INTO kuu_fk_relationships VALUES (null, 'products_to_categories', 'products', 'products_id', 'products_id', 'cascade', 'cascade');
INSERT INTO kuu_fk_relationships VALUES (null, 'products_to_categories', 'categories', 'categories_id', 'categories_id', 'cascade', 'cascade');
INSERT INTO kuu_fk_relationships VALUES (null, 'products_variants', 'products', 'products_id', 'products_id', 'cascade', 'cascade');
INSERT INTO kuu_fk_relationships VALUES (null, 'products_variants', 'products_variants_values', 'products_variants_values_id', 'id', 'cascade', 'cascade');
INSERT INTO kuu_fk_relationships VALUES (null, 'products_variants_groups', 'languages', 'languages_id', 'languages_id', 'cascade', 'cascade');
INSERT INTO kuu_fk_relationships VALUES (null, 'products_variants_values', 'languages', 'languages_id', 'languages_id', 'cascade', 'cascade');
INSERT INTO kuu_fk_relationships VALUES (null, 'products_variants_values', 'products_variants_groups', 'products_variants_groups_id', 'id', 'cascade', 'cascade');
INSERT INTO kuu_fk_relationships VALUES (null, 'reviews', 'products', 'products_id', 'products_id', 'cascade', 'cascade');
INSERT INTO kuu_fk_relationships VALUES (null, 'reviews', 'customers', 'customers_id', 'customers_id', 'cascade', 'cascade');
INSERT INTO kuu_fk_relationships VALUES (null, 'reviews', 'languages', 'languages_id', 'languages_id', 'cascade', 'cascade');
INSERT INTO kuu_fk_relationships VALUES (null, 'shipping_availability', 'languages', 'languages_id', 'languages_id', 'cascade', 'cascade');
INSERT INTO kuu_fk_relationships VALUES (null, 'shopping_carts', 'customers', 'customers_id', 'customers_id', 'cascade', 'cascade');
INSERT INTO kuu_fk_relationships VALUES (null, 'shopping_carts', 'products', 'products_id', 'products_id', 'cascade', 'cascade');
INSERT INTO kuu_fk_relationships VALUES (null, 'shopping_carts_custom_variants_values', 'customers', 'customers_id', 'customers_id', 'cascade', 'cascade');
INSERT INTO kuu_fk_relationships VALUES (null, 'shopping_carts_custom_variants_values', 'products', 'products_id', 'products_id', 'cascade', 'cascade');
INSERT INTO kuu_fk_relationships VALUES (null, 'shopping_carts_custom_variants_values', 'products_variants_values', 'products_variants_values_id', 'id', 'cascade', 'cascade');
INSERT INTO kuu_fk_relationships VALUES (null, 'specials', 'products', 'products_id', 'products_id', 'cascade', 'cascade');
INSERT INTO kuu_fk_relationships VALUES (null, 'tax_rates', 'geo_zones', 'tax_zone_id', 'geo_zone_id', 'cascade', 'cascade');
INSERT INTO kuu_fk_relationships VALUES (null, 'tax_rates', 'tax_class', 'tax_class_id', 'tax_class_id', 'cascade', 'cascade');
INSERT INTO kuu_fk_relationships VALUES (null, 'templates_boxes_to_pages', 'templates_boxes', 'templates_boxes_id', 'id', 'cascade', 'cascade');
INSERT INTO kuu_fk_relationships VALUES (null, 'templates_boxes_to_pages', 'templates', 'templates_id', 'id', 'cascade', 'cascade');
INSERT INTO kuu_fk_relationships VALUES (null, 'weight_classes', 'languages', 'language_id', 'languages_id', 'cascade', 'cascade');
INSERT INTO kuu_fk_relationships VALUES (null, 'weight_classes_rules', 'weight_classes', 'weight_class_from_id', 'weight_class_id', 'cascade', 'cascade');
INSERT INTO kuu_fk_relationships VALUES (null, 'weight_classes_rules', 'weight_classes', 'weight_class_to_id', 'weight_class_id', 'cascade', 'cascade');
INSERT INTO kuu_fk_relationships VALUES (null, 'whos_online', 'customers', 'customer_id', 'customers_id', 'cascade', 'cascade');
INSERT INTO kuu_fk_relationships VALUES (null, 'zones', 'countries', 'zone_country_id', 'countries_id', 'cascade', 'cascade');
INSERT INTO kuu_fk_relationships VALUES (null, 'zones_to_geo_zones', 'countries', 'zone_country_id', 'countries_id', 'cascade', 'cascade');
INSERT INTO kuu_fk_relationships VALUES (null, 'zones_to_geo_zones', 'zones', 'zone_id', 'zone_id', 'cascade', 'cascade');
INSERT INTO kuu_fk_relationships VALUES (null, 'zones_to_geo_zones', 'geo_zones', 'geo_zone_id', 'geo_zone_id', 'cascade', 'cascade');
