 ...
 */
  ...
  class Payment {
    ...
    public function __construct() {
      ...
      $Qmodules = $KUUZU_PDO->prepare('select code from :table_modules where modules_group = :modules_group');
      ...
      $KUUZU_Language->load('modules-payment');
    }

    public function loadAll() {
      foreach ( $this->_modules as $module ) {
        $module_class = 'Kuuzu\\KU\\Core\\Site\\Shop\\Module\\Payment\\' . $module;
    ...
    function getJavascriptBlocks() {
      ...
      if ( is_array($this->_modules) ) {
        $js = '<script type="text/javascript"><!-- ' . "\n" .
              'function check_form() {' . "\n" .
              '  var error = 0;' . "\n" .
              '  var error_message = "' . KUUZU::getDef('js_error') . '";' . "\n" .
        ...
        $js .= "\n" . '  if (payment_value == null) {' . "\n" .
               '    error_message = error_message + "' . KUUZU::getDef('js_no_payment_module_selected') . '\n";' . "\n" .
               '    error = 1;' . "\n" .
               '  }' . "\n\n" .
               '  if (error == 1) {' . "\n" .
               '    alert(error_message);' . "\n" .
