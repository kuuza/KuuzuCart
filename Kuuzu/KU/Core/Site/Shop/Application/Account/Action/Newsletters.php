 ...
 */
  ...
  class Newsletters {
    public static function execute(ApplicationAbstract $application) {
      ...
      $application->setPageTitle(KUUZU::getDef('newsletters_heading'));
      $application->setPageContent('newsletters.php');

      if ( $KUUZU_Service->isStarted('Breadcrumb') ) {
        $KUUZU_Breadcrumb->add(KUUZU::getDef('breadcrumb_newsletters'), KUUZU::getLink(null, null, 'Newsletters', 'SSL'));
      }
    }
  }
?>
