 ...
 */
  ...
  class Cookies {
    public static function execute(ApplicationAbstract $application) {
      ...
      $application->setPageTitle(KUUZU::getDef('info_cookie_usage_heading'));
      $application->setPageContent('cookies.php');

      if ( $KUUZU_Service->isStarted('Breadcrumb') ) {
        $KUUZU_Breadcrumb->add(KUUZU::getDef('breadcrumb_cookie_usage'), KUUZU::getLink(null, null, 'Cookies'));
      }
    }
  }
?>
