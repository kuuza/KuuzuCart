...
<form name="checkout_address" action="<?php echo KUUZU::getLink(null, null, 'Shipping&Address&Process', 'SSL'); ?>" method="post" onsubmit="return check_form_optional(checkout_address);">
...
<div class="moduleBox">
  ...
  <div class="content">
    ...
    <?php echo KUUZU::getDef('selected_shipping_destination'); ?>
...
<div class="moduleBox">
  ...
  <div class="content">
    ...
    <p style="margin-top: 0px;"><?php echo KUUZU::getDef('select_another_shipping_destination'); ?></p>
...
<?php
       if ( $Qaddresses->valueInt('address_book_id') == $KUUZU_ShoppingCart->getShippingAddress('id') ) {
...
?>
            ...
            <td align="right"><?php echo HTML::radioField('ab', $Qaddresses->valueInt('address_book_id'), (string)$KUUZU_ShoppingCart->getShippingAddress('id')); ?></td>
            <td width="10">&nbsp;</td>
          </tr>
          <tr>
            <td width="10">&nbsp;</td>
...
<div class="moduleBox">
  ...
  <h6><?php echo KUUZU::getDef('new_shipping_address_title'); ?></h6>

  <div class="content">
    <?php echo KUUZU::getDef('new_shipping_address'); ?>
...
<div class="moduleBox">
  <div class="content">
    ...
    <?php echo '<b>' . KUUZU::getDef('continue_checkout_procedure_title') . '</b><br />' . KUUZU::getDef('continue_checkout_procedure_to_shipping'); ?>
  </div>
</div>
