 ...
 */
    ...
    public static function getCountries() {
      ...
      if ( !isset($countries) ) {
        ...
        $Qcountries = $KUUZU_PDO->query('select * from :table_countries order by countries_name');
        $Qcountries->execute();
    ...
    public static function countryExists($id) {
      ...
      $Qcountry = $KUUZU_PDO->prepare($sql);
 ...
 */
    ...
    public static function getCountryName($id) {
      ...
      $Qcountry = $KUUZU_PDO->prepare('select countries_name from :table_countries where countries_id = :countries_id');
      $Qcountry->bindInt(':countries_id', $id);
      $Qcountry->execute();
 ...
 */
    ...
    public static function getCountryIsoCode2($id) {
      ...
      $Qcountry = $KUUZU_PDO->prepare('select countries_iso_code_2 from :table_countries where countries_id = :countries_id');
      $Qcountry->bindInt(':countries_id', $id);
      $Qcountry->execute();
 ...
 */
    ...
    public static function getCountryIsoCode3($id) {
      ...
      $Qcountry = $KUUZU_PDO->prepare('select countries_iso_code_3 from :table_countries where countries_id = :countries_id');
      $Qcountry->bindInt(':countries_id', $id);
      $Qcountry->execute();
 ...
 */
    ...
    public static function getFormat($id) {
      ...
      $Qcountry = $KUUZU_PDO->prepare('select address_format from :table_countries where countries_id = :countries_id');
      $Qcountry->bindInt(':countries_id', $id);
      $Qcountry->execute();
    ...
    public static function getZoneId(int $country_id, string $zone_code) {
      ...
      $Qzone = $KUUZU_PDO->prepare('select zone_id from :table_zones where zone_country_id = :zone_country_id and zone_code = :zone_code');
 ...
 */
    ...
    public static function getZoneName($id) {
      ...
      $Qzone = $KUUZU_PDO->prepare('select zone_name from :table_zones where zone_id = :zone_id');
 ...
 */
    ...
    public static function getZoneCode($id) {
      ...
      $Qzone = $KUUZU_PDO->prepare('select zone_code from :table_zones where zone_id = :zone_id');
      $Qzone->bindInt(':zone_id', $id);
      $Qzone->execute();
 ...
 */
    ...
    public static function hasZones($id) {
      ...
      $Qzones = $KUUZU_PDO->prepare('select zone_id from :table_zones where zone_country_id = :zone_country_id limit 1');
 ...
 */
    ...
    public static function getZones($id = null) {
      ...
      if ( !empty($id) ) {
        $Qzones = $KUUZU_PDO->prepare($sql_query);
        ...
        $Qzones = $KUUZU_PDO->query($sql_query);
      }
