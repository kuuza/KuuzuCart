 ...
 */
  ...
  class PayPalExpressCheckout extends \Kuuzu\KU\Core\Site\Admin\PaymentModuleAbstract {
 ...
 */
    ...
    protected function initialize() {
      ...
      $this->_description = KUUZU::getDef('paypal_express_checkout_description');
    ...
    public function install() {
      ...
      $data = array(array('title' => 'Enable PayPal Express Checkout',
                    ...
                    array('title' => 'Transaction Server',
                          ...
                          'group_id' => '6',
                          'set_function' => 'kuu_cfg_set_boolean_value(array(\'Live\', \'Sandbox\'))'),
                    array('title' => 'Transaction Method',
                          ...
                          'group_id' => '6',
                          'set_function' => 'kuu_cfg_set_boolean_value(array(\'Authorization\', \'Sale\'))'),
                    ...
                    array('title' => 'PayPal Checkout Image',
                          ...
                          'group_id' => '6',
                          'set_function' => 'kuu_cfg_set_boolean_value(array(\'Static\', \'Dynamic\'))'),
