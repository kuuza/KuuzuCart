 ...
 */
  ...
  class Debug extends \Kuuzu\KU\Core\Site\Admin\ServiceAbstract {
    var $depends = 'Language';

    protected function initialize() {
      $this->title = KUUZU::getDef('services_debug_title');
      $this->description = KUUZU::getDef('services_debug_description');
    }
