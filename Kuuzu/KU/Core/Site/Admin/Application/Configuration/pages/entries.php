...
<table border="0" width="100%" cellspacing="0" cellpadding="2" class="dataTable" id="configurationDataTable">
  <thead>
    <tr>
      <th width="35%;"><?php echo KUUZU::getDef('table_heading_title'); ?></th>
  ...
  <tfoot>
    <tr>
      <th align="right" colspan="3"><?php echo HTML::submitImage(HTML::iconRaw('edit.png'), KUUZU::getDef('icon_edit'), 'onclick="document.batch.action=\'' . KUUZU::getLink(null, null, 'BatchSaveEntries&id=' . $_GET['id']) . '\';"'); ?></th>
      <th align="center" width="20"><?php echo HTML::checkboxField('batchFlag', null, null, 'onclick="flagCheckboxes(this);"'); ?></th>
    </tr>
  </tfoot>
  <tbody>
...
<div style="padding: 2px; min-height: 16px;">
  <span id="dataTableLegend"><?php echo '<b>' . KUUZU::getDef('table_action_legend') . '</b> ' . HTML::icon('edit.png') . '&nbsp;' . KUUZU::getDef('icon_edit'); ?></span>
...
<script type="text/javascript">
  ...
  var configEditLink = '<?php echo KUUZU::getLink(null, null, 'EntrySave&id=' . (int)$_GET['id'] . '&pID=CONFIGID'); ?>';
