...
<table border="0" width="100%" cellspacing="0" cellpadding="2" class="dataTable" id="logDataTable">
  <thead>
    <tr>
      <th><?php echo KUUZU::getDef('table_heading_log_date'); ?></th>
      <th><?php echo KUUZU::getDef('table_heading_log_message'); ?></th>
    </tr>
  </thead>
  <tfoot>
    <tr>
...
<script>
  ...
  var dataTableDataURL = '<?php echo KUUZU::getRPCLink(null, null, 'GetLog&log=' . $_GET['log']); ?>';
