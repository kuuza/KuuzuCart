 ...
 */
  ...
  namespace Kuuzu\KU\Core\Site\Admin\Application\Categories\SQL\PostgreSQL;
  ...
  class Save {
    public static function execute($data) {
      ...
      if ( is_numeric($data['id']) ) {
        ...
        $Qcat = $KUUZU_PDO->prepare('insert into :table_categories (parent_id, date_added) values (:parent_id, now()) returning categories_id');
      }
