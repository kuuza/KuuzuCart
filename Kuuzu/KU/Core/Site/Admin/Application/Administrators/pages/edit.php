...
<div class="infoBox">
  <h3><?php echo HTML::icon('edit.png') . ' ' . $KUUZU_ObjectInfo->getProtected('user_name'); ?></h3>

  <form name="aEdit" class="dataForm" autocomplete="off" action="<?php echo KUUZU::getLink(null, null, 'Save&Process&id=' . $KUUZU_ObjectInfo->getInt('id')); ?>" method="post">

  <p><?php echo KUUZU::getDef('introduction_edit_administrator'); ?></p>

  <fieldset>
    <p><label for="user_name"><?php echo KUUZU::getDef('field_username'); ?></label><?php echo HTML::inputField('user_name', $KUUZU_ObjectInfo->get('user_name')); ?></p>
    <p><label for="user_password"><?php echo KUUZU::getDef('field_password'); ?></label><?php echo HTML::passwordField('user_password'); ?></p>
...
<script type="text/javascript">
  ...
  var hasAccessTo = <?php echo json_encode($KUUZU_ObjectInfo->get('access_modules')); ?>;
