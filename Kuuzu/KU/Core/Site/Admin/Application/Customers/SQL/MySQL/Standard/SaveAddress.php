 ...
 */
  ...
  namespace Kuuzu\KU\Core\Site\Admin\Application\Customers\SQL\MySQL\Standard;
    ...
    public static function execute($data) {
      ...
      if ( !$Qab->isError() ) {
        if ( isset($data['default']) && ($data['default'] === true) ) {
          $address_book_id = ( isset($data['id']) && is_numeric($data['id']) ) ? $data['id'] : $KUUZU_PDO->lastInsertId();
