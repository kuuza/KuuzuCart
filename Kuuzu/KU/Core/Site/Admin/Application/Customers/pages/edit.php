 ...
 */
  ...
  $KUUZU_ObjectInfo = new ObjectInfo(Customers::get($_GET['id']));
?>
...
<form id="cEditForm" name="cEdit" class="dataForm" action="<?php echo KUUZU::getLink(null, null, 'Save&Process&id=' . $_GET['id']); ?>" method="post">
