...
<?php
  if ( $new_customer === false ) {
    echo $address_fields . HTML::hiddenField('ab_default_id', $KUUZU_ObjectInfo->get('customers_default_address_id'));
  }
?>

<div id="dialogDeleteAddress" title="<?php echo HTML::output(KUUZU::getDef('dialog_delete_address_title')); ?>">
  <p><span class="ui-icon ui-icon-alert" style="float: left; margin: 0 7px 20px 0;"></span><?php echo KUUZU::getDef('dialog_delete_address_desc'); ?></p>
</div>

<div id="dialogDeleteNewAddress" title="<?php echo HTML::output(KUUZU::getDef('dialog_delete_new_address_title')); ?>">
  <p><span class="ui-icon ui-icon-alert" style="float: left; margin: 0 7px 20px 0;"></span><?php echo KUUZU::getDef('dialog_delete_new_address_desc'); ?></p>
</div>

<div id="dialogDeleteDefaultAddress" title="<?php echo HTML::output(KUUZU::getDef('dialog_delete_default_address_title')); ?>">
  <p><span class="ui-icon ui-icon-alert" style="float: left; margin: 0 7px 20px 0;"></span><?php echo KUUZU::getDef('dialog_delete_default_address_desc'); ?></p>
</div>
...
?>
    ...
    <p id="abGenderFields"><label for="ab_gender"><?php echo KUUZU::getDef('field_gender'); ?></label><?php echo HTML::radioField('ab_gender', $gender_array, 'm', null, ''); ?></p>
...
?>
    ...
    <p><label for="ab_firstname"><?php echo KUUZU::getDef('field_first_name'); ?></label><?php echo HTML::inputField('ab_firstname'); ?></p>
    <p><label for="ab_lastname"><?php echo KUUZU::getDef('field_last_name'); ?></label><?php echo HTML::inputField('ab_lastname'); ?></p>
...
?>
    ...
    <p><label for="ab_company"><?php echo KUUZU::getDef('field_company'); ?></label><?php echo HTML::inputField('ab_company'); ?></p>

<?php
  }
?>

    <p><label for="ab_street_address"><?php echo KUUZU::getDef('field_street_address'); ?></label><?php echo HTML::inputField('ab_street_address'); ?></p>

<?php
  if ( ACCOUNT_SUBURB > -1 ) {
?>

    <p><label for="ab_suburb"><?php echo KUUZU::getDef('field_suburb'); ?></label><?php echo HTML::inputField('ab_suburb'); ?></p>

<?php
  }
?>

    <p><label for="ab_postcode"><?php echo KUUZU::getDef('field_post_code'); ?></label><?php echo HTML::inputField('ab_postcode'); ?></p>
    <p><label for="ab_city"><?php echo KUUZU::getDef('field_city'); ?></label><?php echo HTML::inputField('ab_city'); ?></p>
...
?>
    ...
    <p><label for="ab_country"><?php echo KUUZU::getDef('field_country'); ?></label><?php echo HTML::selectMenu('ab_country', $countries_array, STORE_COUNTRY); ?></p>
...
?>
    ...
    <p><label for="ab_state"><?php echo KUUZU::getDef('field_state'); ?></label><?php echo HTML::selectMenu('ab_state', $zones_array); ?></p>

<?php
    } else {
?>

    <p><label for="ab_state"><?php echo KUUZU::getDef('field_state'); ?></label><?php echo HTML::inputField('ab_state'); ?></p>
...
?>
    ...
    <p><label for="ab_telephone"><?php echo KUUZU::getDef('field_telephone_number'); ?></label><?php echo HTML::inputField('ab_telephone'); ?></p>
...
?>
    ...
    <p><label for="ab_fax"><?php echo KUUZU::getDef('field_fax_number'); ?></label><?php echo HTML::inputField('ab_fax'); ?></p>

<?php
  }
?>

    <p><label for="ab_default"><?php echo KUUZU::getDef('field_set_as_primary'); ?></label><?php echo HTML::checkboxField('ab_default'); ?></p>

    </fieldset>

    <p id="abSubmitButtonsNew"><?php echo HTML::button(array('type' => 'button', 'params' => 'onclick="processAddress();"', 'priority' => 'primary', 'icon' => 'plus', 'title' => KUUZU::getDef('button_add'))) . ' ' . HTML::button(array('type' => 'button', 'params' => 'onclick="cancelAddressForm();"', 'priority' => 'secondary', 'icon' => 'close', 'title' => KUUZU::getDef('button_cancel'))); ?></p>
    <p id="abSubmitButtonsEdit"><?php echo HTML::button(array('type' => 'button', 'params' => 'data-abButtonType="henrysBucket"', 'priority' => 'primary', 'icon' => 'arrowrefresh-1-n', 'title' => KUUZU::getDef('button_update'))) . ' ' . HTML::button(array('type' => 'button', 'params' => 'onclick="cancelAddressForm();"', 'priority' => 'secondary', 'icon' => 'close', 'title' => KUUZU::getDef('button_cancel'))); ?></p>
  </div>
</div>
...
$(function() {
  $('#ab_country').change(function() {
    ...
    $.getJSON('<?php echo KUUZU::getRPCLink(null, null, 'GetZones'); ?>', { country_id: $('#ab_country').val() }, function (response) {
...
var ab_default_marker = '<div class="abDefault" style="float: left;"><?php echo HTML::icon('default.png', KUUZU::getDef('primary_address')); ?></div>';
...
function processAddress(id) {
  ...
  $.getJSON('<?php echo KUUZU::getRPCLink(null, null, 'FormatAddress'); ?>', data, function (response) {
    if ( response.rpcStatus == 1 ) {
...
// Manually clear a change in the jQuery safetynet plugin
  ...
  $('#dialogDeleteDefaultAddress').dialog({
    ...
    modal: true,
    buttons: {
      '<?php echo addslashes(KUUZU::getDef('button_ok')); ?>': function() {
        $(this).dialog('close');
      }
    }
  });
