...
<form id="liveSearchForm">
  ...
  <span style="float: right;"><?php echo HTML::button(array('href' => KUUZU::getLink(), 'priority' => 'secondary', 'icon' => 'triangle-1-w', 'title' => KUUZU::getDef('button_back'))) . ' ' . HTML::button(array('href' => KUUZU::getLink(null, null, 'InsertDefinition&id=' . $_GET['id']), 'icon' => 'plus', 'title' => KUUZU::getDef('button_insert'))); ?></span>
</form>
...
<table border="0" width="100%" cellspacing="0" cellpadding="2" class="dataTable" id="langDefGroupDataTable">
  <thead>
    <tr>
      <th><?php echo KUUZU::getDef('table_heading_definition_groups'); ?></th>
...
<div style="padding: 2px;">
  <span id="dataTableLegend"><?php echo '<b>' . KUUZU::getDef('table_action_legend') . '</b> ' . HTML::icon('trash.png') . '&nbsp;' . KUUZU::getDef('icon_trash'); ?></span>
...
<script type="text/javascript">
  ...
  var dataTableDataURL = '<?php echo KUUZU::getRPCLink(null, null, 'GetGroups&id=' . $_GET['id']); ?>';

  var groupLink = '<?php echo KUUZU::getLink(null, null, 'id=' . $_GET['id'] . '&group=GROUPCODE'); ?>';
  var groupLinkIcon = '<?php echo HTML::icon('folder.png'); ?>';

  var groupDeleteLink = '<?php echo KUUZU::getLink(null, null, 'DeleteGroup&id=' . $_GET['id'] . '&group=GROUPCODE'); ?>';
