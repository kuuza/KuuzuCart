...
<div class="infoBox">
  <h3><?php echo HTML::icon('trash.png') . ' ' . $KUUZU_ObjectInfo->getProtected('definition_key'); ?></h3>

  <form name="lDelete" class="dataForm" action="<?php echo KUUZU::getLink(null, null, 'DeleteDefinition&Process&id=' . $_GET['id'] . '&group=' . $_GET['group'] . '&dID=' . $_GET['dID']); ?>" method="post">

  <p><?php echo KUUZU::getDef('introduction_delete_language_definition'); ?></p>

  <p><?php echo '<b>' . $KUUZU_ObjectInfo->getProtected('definition_key') . '</b>'; ?></p>
