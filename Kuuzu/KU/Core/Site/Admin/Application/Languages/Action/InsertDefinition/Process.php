 ...
 */
  ...
  namespace Kuuzu\KU\Core\Site\Admin\Application\Languages\Action\InsertDefinition;
  ...
  class Process {
    public static function execute(ApplicationAbstract $application) {
      ...
      KUUZU::redirect(KUUZU::getLink(null, null, 'id=' . $_GET['id'] . (isset($_GET['group']) ? '&group=' . $_GET['group'] : '')));
    }
  }
?>
