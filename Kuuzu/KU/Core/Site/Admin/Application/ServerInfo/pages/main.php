...
<form id="liveSearchForm">
  ...
  <span style="float: right;"><?php echo HTML::button(array('href' => KUUZU::getLink(null, null, 'PHPInfo'), 'icon' => 'info', 'title' => KUUZU::getDef('button_php_info'), 'newwindow' => true)); ?></span>
</form>
