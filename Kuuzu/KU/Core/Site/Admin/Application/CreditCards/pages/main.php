...
<table border="0" width="100%" cellspacing="0" cellpadding="2" class="dataTable" id="ccDataTable">
  <thead>
    <tr>
      <th><?php echo KUUZU::getDef('table_heading_credit_cards'); ?></th>
  ...
  <tfoot>
    <tr>
      <th align="right" colspan="3"><?php echo HTML::submitImage(HTML::iconRaw('edit.png'), KUUZU::getDef('icon_edit'), 'onclick="document.batch.action=\'' . KUUZU::getLink(null, null, 'BatchSave') . '\';"') . '&nbsp;' . HTML::submitImage(HTML::iconRaw('trash.png'), KUUZU::getDef('icon_trash'), 'onclick="document.batch.action=\'' . KUUZU::getLink(null, null, 'BatchDelete') . '\';"'); ?></th>
      <th align="center" width="20"><?php echo HTML::checkboxField('batchFlag', null, null, 'onclick="flagCheckboxes(this);"'); ?></th>
    </tr>
  </tfoot>
  <tbody>
...
<script type="text/javascript">
  ...
  var ccEditLink = '<?php echo KUUZU::getLink(null, null, 'Save&id=CCID'); ?>';
  var ccEditLinkIcon = '<?php echo HTML::icon('edit.png'); ?>';

  var ccDeleteLink = '<?php echo KUUZU::getLink(null, null, 'Delete&id=CCID'); ?>';
