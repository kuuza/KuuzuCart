...
<div class="infoBox">
  <h3><?php echo HTML::icon('trash.png') . ' ' . $KUUZU_ObjectInfo->getProtected('credit_card_name'); ?></h3>
  ...
  <p><?php echo KUUZU::getDef('introduction_delete_card'); ?></p>

  <p><?php echo '<b>' . $KUUZU_ObjectInfo->getProtected('credit_card_name') . '</b>'; ?></p>
