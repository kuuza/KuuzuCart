...
<div class="infoBox">
  <h3><?php echo HTML::icon('edit.png') . ' ' . KUUZU::getDef('action_heading_batch_edit_cards'); ?></h3>

  <form name="ccEditBatch" class="dataForm" action="<?php echo KUUZU::getLink(null, null, 'BatchSave&Process'); ?>" method="post">

  <p><?php echo KUUZU::getDef('introduction_batch_edit_cards'); ?></p>
...
<?php
  ...
  echo '<p>' . HTML::radioField('type', array(array('id' => 'activate', 'text' => KUUZU::getDef('activate')), array('id' => 'deactivate', 'text' => KUUZU::getDef('deactivate'))), 'activate') . '</p>';
?>
