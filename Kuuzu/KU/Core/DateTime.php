 ...
 */
    ...
    public static function getShort($date = null, $with_time = false) {
      ...
      if ( @date('Y', mktime($hour, $minute, $second, $month, $day, $year)) == $year ) {
        return strftime($KUUZU_Language->getDateFormatShort($with_time), mktime($hour, $minute, $second, $month, $day, $year));
      } else {
        return preg_replace('/2037/', $year, strftime($KUUZU_Language->getDateFormatShort($with_time), mktime($hour, $minute, $second, $month, $day, 2037)));
      }
    }
 ...
 */
    ...
    public static function getLong($date = null) {
      ...
      if ( @date('Y', mktime($hour, $minute, $second, $month, $day, $year)) == $year ) {
        return strftime($KUUZU_Language->getDateFormatLong(), mktime($hour, $minute, $second, $month, $day, $year));
      } else {
        return preg_replace('/2037/', $year, strftime($KUUZU_Language->getDateFormatLong(), mktime($hour, $minute, $second, $month, $day, 2037)));
      }
    }
 ...
 */
    ...
    public static function setTimeZone($time_zone = null, $site = 'KUUZU') {
      if ( !isset($time_zone) ) {
        if ( KUUZU::configExists('time_zone', $site) ) {
          $time_zone = KUUZU::getConfig('time_zone', $site);
        } else {
