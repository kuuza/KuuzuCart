 ...
 */
  ...
  class CreditCard {
    ...
    public function __construct($number = null, $exp_month = null, $exp_year = null) {
      ...
      $Qcc = $KUUZU_PDO->prepare('select id, credit_card_name as title, pattern from :table_credit_cards where credit_card_status = 1 order by sort_order, credit_card_name');
