...
// HPDL: Check for and include custom version
        if ( strpos($includeFile, 'Kuuzu' . DIRECTORY_SEPARATOR . 'KU' . DIRECTORY_SEPARATOR . 'Core' . DIRECTORY_SEPARATOR) !== false ) {
          ...
          $custom_includeFile = str_replace('Kuuzu' . DIRECTORY_SEPARATOR . 'KU' . DIRECTORY_SEPARATOR . 'Core' . DIRECTORY_SEPARATOR, 'Kuuzu' . DIRECTORY_SEPARATOR . 'KU' . DIRECTORY_SEPARATOR . 'Tests' . DIRECTORY_SEPARATOR . 'Kuuzu' . DIRECTORY_SEPARATOR . 'KU' . DIRECTORY_SEPARATOR . 'Core' . DIRECTORY_SEPARATOR, $includeFile);
